      ...
      <div class="relative z-10 text-center max-w-2xl mx-auto w-full">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center px-2 sm:px-0">
          ...
          >
            ...
            <h3 class="text-white font-semibold text-lg mb-1">Portal Trabajadores</h3>
            <p class="text-white/50 text-sm">Trabajadores</p>
          </a>
          ...
          >
            ...
            <p class="text-white/50 text-sm">Postulantes</p>
          </a>
        </div>
