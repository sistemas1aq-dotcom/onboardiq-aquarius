...
(1, 'DNI', 'dni_carlos_mendoza.pdf', 'ok', TRUE),
(1, 'CV', 'cv_carlos_mendoza.pdf', 'ok', TRUE),
(1, 'Foto Pasaporte', NULL, 'pending', TRUE),
(1, 'Certificados Estudio', 'cert_estudios_mendoza.pdf', 'ok', TRUE),
(1, 'Constancias Laborales', 'constancias_mendoza.pdf', 'ok', TRUE),
(1, 'Licencia Conducir', NULL, 'na', FALSE),
(1, 'Antecedentes Policiales', NULL, 'pending', FALSE),
(1, 'Antecedentes Penales', NULL, 'pending', FALSE),
(1, 'Certificado Medico', NULL, 'pending', FALSE),
(1, 'Cert. Capacitacion', 'capacitacion_mendoza.pdf', 'ok', FALSE);
...
('Seguridad y Salud en el Trabajo', 'Curso obligatorio de SST segun ley peruana', '2026-04-10', TRUE),
('Codigo de Etica Corporativa', 'Conocimiento del codigo de etica de la empresa', '2026-04-05', TRUE),
('Manejo de Residuos', 'Capacitacion en gestion ambiental', '2026-04-15', FALSE);
